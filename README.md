...
*items* - Массив строк, из которых будет строится отчет. Растояние между типами строк 10 px.
...
*data.groups* - Группировка колонок. Не обязательный параметр. Если не передано, то колонки не группируются.
...
Суперсет в дневнике тренировок. Это объединение нескольких упражнений в один блок.
